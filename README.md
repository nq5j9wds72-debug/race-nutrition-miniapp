...
- Завершён День 16
- Текущий день: День 17
- Цель Дня 17:
  - зафиксировать итог Дня 16 в README
  - обновить разделы про реальные диапазоны и enum-валидацию
  - подготовить список следующей честной синхронизации form ↔ server ↔ maths
...
### Как сейчас влияет `effort_level` на carbs
